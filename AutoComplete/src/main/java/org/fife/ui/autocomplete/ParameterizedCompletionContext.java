...
public class ParameterizedCompletionContext {
	 ...
	 */
	private static int getFirstHighlight(List<Highlight> highlights) {
		int first = -1;
	 ...
	 */
	private static int getLastHighlight(List<Highlight> highlights) {
		int last = -1;
	...
	private static class ParamCopyInfo {
		...
		ParamCopyInfo(String paramName, Highlight h) {
